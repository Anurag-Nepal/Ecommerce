...
public class UserController {
	...
	public String home(Model model){
		List<Product> latestEightActiveProducts = productService.getLatestEightActiveProducts();
	...
	public String placeOrder(Principal principal,
		...
		try {
			...
			Boolean orderSaved = orderService.saveOrder(user.getId(), carts, totalOrderPrice, address, city, state, zipCode, phoneNumber);
